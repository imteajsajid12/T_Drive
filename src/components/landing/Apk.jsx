          ...
          <div className="order-2 lg:order-1">
            ...
            <SectionWrapper>
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <motion.a href="https://drive.google.com/drive/folders/1hABR5jxrFeE1gKzsJ0uxetASVjmyEZKC" whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.95 }} className="group flex items-center gap-3 px-6 py-4 rounded-2xl transition-all shadow-lg bg-gray-900 hover:bg-gray-800">
